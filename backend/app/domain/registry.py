...
REFERENCE_FIELDS: dict[str, set[str]] = {
    "incident": {"caller_id", "assigned_to", "assignment_group", "owner", "owner_group"},
    "problem": {"assigned_to", "assignment_group", "duplicate_of", "owner", "owner_group"},
    "problem_task": {"problem", "cmdb_ci", "assigned_to", "assignment_group", "owner", "owner_group"},
    "change_request": {
        "requested_by",
        "assigned_to",
        "assignment_group",
    ...
    "change_task": {"change_request", "cmdb_ci", "assigned_to", "assignment_group", "owner", "owner_group"},
    "cmdb_ci": {"assigned_to", "owner", "owner_group"},
    "sc_request": {"requested_for", "requested_by", "assignment_group", "assigned_to", "owner", "owner_group"},
    "sc_task": {"request", "assigned_to", "assignment_group", "owner", "owner_group"},
    "sys_user_group": {"owner"},
