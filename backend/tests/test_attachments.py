...
from app.api.snow.attachment import delete_attachments_for_parent, remove_attachment
...
async def test_delete_attachments_for_parent_removes_all_records():
    ...
    with patch("app.api.snow.attachment._remove_attachment_file") as remove_file:
