...
export function HierarchyIcon({ size = 18 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" aria-hidden="true">
      ...
      <path
        d="M12 7.5v4M12 11.5 6 15.5M12 11.5l6 4"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinecap="round"
      />
...
export function GovernanceIcon({ size = 18 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" aria-hidden="true">
      <path
...
export function FieldsIcon({ size = 18 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" aria-hidden="true">
      <rect x="3" y="5" width="18" height="14" rx="2" stroke="currentColor" strokeWidth="2" />
      <path d="M7 9h4M7 12h10M7 15h7" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
    </svg>
  );
}
...
export function SectionsNavIcon({ size = 18 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" aria-hidden="true">
      <path
